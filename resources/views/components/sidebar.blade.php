    ...
    <div class="flex flex-col w-64 h-full">
        ...
        <div class="flex flex-col h-full bg-white/10 backdrop-blur-xl border-r border-white/20">
            ...
            <div class="px-4 py-4 space-y-2 border-t border-white/10">
                ...
                <a href="{{ route('maintenance') }}" class="w-full mt-4 px-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center">
