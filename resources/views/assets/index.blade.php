            ...
            aemsFetch('/api/assets')
                ...
                .then(data => {
                    ...
                    if (!data.success || !data.data.data || data.data.data.length === 0) {
                        tbody.innerHTML = `<tr><td colspan="7" class="px-12 py-16 text-center">
                            <div class="flex flex-col items-center">
                                <svg class="w-16 h-16 text-gray-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path>
                                </svg>
                                <p class="text-gray-500 font-medium text-lg mb-1">No assets yet</p>
                                <p class="text-gray-400 text-sm mb-4">Start tracking your organization's assets</p>
                                <a href="/assets/create" class="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 text-sm font-medium">+ Add Your First Asset</a>
                            </div>
                        </td></tr>`;
                        return;
                    }
